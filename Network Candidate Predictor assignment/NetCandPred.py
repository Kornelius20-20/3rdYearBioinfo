...
class NetCandPred:
    ...
    def __init__(self, networkfile, delimitter='\t'):
        """

        Default constructor that creates a graph using a text file containing a edge data

        :param networkfile: text file containing edge data
        :param delimitter: default  is '\t'
        """
        self.graph = make_graph(networkfile, delimitter)

    def __init__(self, networkfile, infofile):
        """
